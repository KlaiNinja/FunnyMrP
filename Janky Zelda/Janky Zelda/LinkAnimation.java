...
public class Link extends Actor
{
    ...
    public void basicMoving()
    {
        ...
        //Change movement
        if (Greenfoot.isKeyDown("a")&&ymove==0){xmove=-m; setImage(sprites[0]);}
        if (Greenfoot.isKeyDown("d")&&ymove==0){xmove=m; setImage(sprites[4]);}
        if (Greenfoot.isKeyDown("w")&&xmove==0){ymove=-m; setImage(sprites[6]);}
        if (Greenfoot.isKeyDown("s")&&xmove==0){ymove=m; setImage(sprites[2]);}
