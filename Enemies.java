...
public class Enemies extends Actor
{
    ...
    public Enemies(int maxHealth, int atk, int roomID){
        ...
        this.roomID = roomID;
        this.reset();
        player = RandomlyGeneratingDungeon.instance.player;
        enabled = false;
    }
    ...
    if (player.currentDir == Link.Dir.down){
                        this.kbDir = Dir.down;
                    } else if (player.currentDir == Link.Dir.up){
                        this.kbDir = Dir.up;
                    } else if (player.currentDir == Link.Dir.left){
                        this.kbDir = Dir.left;
                    } else if (player.currentDir == Link.Dir.right){
                        this.kbDir = Dir.right;
                    }
    }
    ...
    public void destroy(){
        ...
        Room room = RandomlyGeneratingDungeon.instance.map.getCurrentRoom();
